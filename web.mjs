...
;
	($.$bog_bhelper_app_prof) = class $bog_bhelper_app_prof extends ($.$mol_page) {
		query(next){
			if(next !== undefined) return next;
			return "";
		}
		Search(){
			const obj = new this.$.$mol_string();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_bhelper_app_prof_Search_hint")));
			(obj.value) = (next) => ((this.query(next)));
			return obj;
		}
		...
		title(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_prof_title"));
		}
		body(){
	...
	($mol_mem(($.$bog_bhelper_app_prof.prototype), "query"));
	($mol_mem(($.$bog_bhelper_app_prof.prototype), "Search"));
	($mol_mem(($.$bog_bhelper_app_prof.prototype), "Helpers_gallery"));
	($mol_mem_key(($.$bog_bhelper_app_prof.prototype), "Helper_item_open"));
	($mol_mem_key(($.$bog_bhelper_app_prof.prototype), "Helper_title_view"));
	($mol_mem_key(($.$bog_bhelper_app_prof.prototype), "Helper_descr_view"));
	($mol_mem_key(($.$bog_bhelper_app_prof.prototype), "Helper_link"));
	($mol_mem_key(($.$bog_bhelper_app_prof.prototype), "Helper_item"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_action
        ], $bog_bhelper_app_prof.prototype, "Helper_item_open", null);
        $$.$bog_bhelper_app_prof = $bog_bhelper_app_prof;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_bhelper_app_crm) = class $bog_bhelper_app_crm extends ($.$mol_page) {
		title_label(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_crm_title_label"));
		}
		subtitle_label(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_crm_subtitle_label"));
		}
		Title_block(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.title_label()), (this.subtitle_label())]);
			return obj;
		}
		add_label(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_crm_add_label"));
		}
		client_add(next){
			if(next !== undefined) return next;
			return "";
		...
		AddClient(){
			...
			(obj.click) = (next) => ((this.client_add(next)));
			return obj;
		}
		Header(){
			const obj = new this.$.$mol_row();
			(obj.sub) = () => ([(this.Title_block()), (this.AddClient())]);
			return obj;
		}
		search(next){
			if(next !== undefined) return next;
		...
		Search(){
			const obj = new this.$.$mol_string();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_bhelper_app_crm_Search_hint")));
		...
		StatusFilter(){
			...
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_bhelper_app_crm_StatusFilter_hint")));
			(obj.options) = (next) => ((this.status_options()));
		...
		SegmentFilter(){
			const obj = new this.$.$mol_select();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_bhelper_app_crm_SegmentFilter_hint")));
			(obj.options) = (next) => ((this.segment_options()));
			(obj.value) = (next) => ((this.segment_filter(next)));
			return obj;
		}
		manager_options(next){
			if(next !== undefined) return next;
			return [];
		}
		manager_filter(next){
		...
		ManagerFilter(){
			const obj = new this.$.$mol_select();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_bhelper_app_crm_ManagerFilter_hint")));
			(obj.options) = (next) => ((this.manager_options()));
			(obj.value) = (next) => ((this.manager_filter(next)));
			return obj;
		}
		reset_label(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_crm_reset_label"));
		}
		filters_reset(next){
			if(next !== undefined) return next;
			return "";
		...
		Col_name(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_crm_Col_name"));
		}
		Col_status(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_crm_Col_status"));
		}
		Col_segment(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_crm_Col_segment"));
		}
		Col_city(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_crm_Col_city"));
		}
		Col_last_contact(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_crm_Col_last_contact"));
		}
		Col_next_action(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_crm_Col_next_action"));
		}
		Col_manager(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_crm_Col_manager"));
		}
		TableHeader(){
			const obj = new this.$.$mol_row();
			(obj.sub) = () => ([
				...
				(this.Col_segment()), 
				(this.Col_city()), 
				(this.Col_last_contact()), 
				(this.Col_next_action()), 
				(this.Col_manager())
			]);
			return obj;
		}
		...
		PageInfo(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.page_info_text())]);
			return obj;
		}
		prev_label(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_crm_prev_label"));
		}
		page_prev(next){
			if(next !== undefined) return next;
			return "";
		...
		PrevPage(){
			const obj = new this.$.$mol_button_minor();
			(obj.enabled) = (next) => ((this.page_has_prev()));
			(obj.sub) = () => ([(this.prev_label())]);
			(obj.click) = (next) => ((this.page_prev(next)));
			return obj;
		}
		next_label(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_crm_next_label"));
		}
		page_next(next){
			if(next !== undefined) return next;
			return "";
		...
		NextPage(){
			const obj = new this.$.$mol_button_minor();
			(obj.enabled) = (next) => ((this.page_has_next()));
		...
		title(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_crm_title"));
		}
		sub(){
			return [
				(this.Header()), 
	...
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "Title_block"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "client_add"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "AddClient"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "Header"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "search"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "Search"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "status_options"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "status_filter"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "StatusFilter"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "segment_options"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "segment_filter"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "SegmentFilter"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "manager_options"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "manager_filter"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "ManagerFilter"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "filters_reset"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "ResetFilters"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "Filters"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "TableHeader"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "Table"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "PageInfo"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "page_prev"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "PrevPage"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "page_next"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "NextPage"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "Pagination"));
	($mol_mem(($.$bog_bhelper_app_crm.prototype), "TableCard"));
	($.$bog_bhelper_app_crm_client_row) = class $bog_bhelper_app_crm_client_row extends ($.$mol_row) {
		Name(){
			return "";
		}
		Company(){
		...
		NameBlock(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Name()), (this.Company())]);
			return obj;
		}
		Status(){
			return "";
		...
		attr(){
			return {"mol_theme": "bog_bhelper_row"};
		}
		sub(){
			return [
				(this.NameBlock()), 
	...
	($mol_mem(($.$bog_bhelper_app_crm_client_row.prototype), "NameBlock"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_bhelper_crm_profile extends $hyoo_crus_dict.with({
            Clients: $hyoo_crus_list_ref_to(() => $bog_bhelper_crm_client),
        }) {
        }
        $$.$bog_bhelper_crm_profile = $bog_bhelper_crm_profile;
        class $bog_bhelper_crm_client extends $hyoo_crus_dict.with({
            Name: $hyoo_crus_atom_str,
            Company: $hyoo_crus_atom_str,
            ...
            PreferredChannel: $hyoo_crus_atom_str,
            ManagerName: $hyoo_crus_atom_str,
            City: $hyoo_crus_atom_str,
            AverageCheck: $hyoo_crus_atom_str,
            LTV: $hyoo_crus_atom_str,
            VisitFrequency: $hyoo_crus_atom_str,
            PipelineStage: $hyoo_crus_atom_str,
            LastContactAt: $hyoo_crus_atom_str,
            NextActionAt: $hyoo_crus_atom_str,
            IsVIP: $hyoo_crus_atom_bool,
            LastNote: $hyoo_crus_text,
            AiSummary: $hyoo_crus_text,
            AiNextStep: $hyoo_crus_text,
            CreatedAt: $hyoo_crus_atom_str,
            UpdatedAt: $hyoo_crus_atom_str,
            TagsCsv: $hyoo_crus_text,
        }) {
        }
        $$.$bog_bhelper_crm_client = $bog_bhelper_crm_client;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_bhelper_app_crm extends $.$bog_bhelper_app_crm {
            realm() {
            ...
            status_filter(next) { return next ?? ''; }
            segment_filter(next) { return next ?? ''; }
            manager_filter(next) { return next ?? ''; }
            filters_reset() {
                this.search('');
                this.status_filter('');
                this.segment_filter('');
            ...
            clients_filtered() {
                ...
                return this.clients_all().filter(client => {
                    ...
                    if (status && client.Status(null)?.val() !== status)
                        return false;
                    if (segment && client.Segment(null)?.val() !== segment)
                        return false;
                    if (manager && client.ManagerName(null)?.val() !== manager)
                        return false;
                    return true;
                });
            }
            ...
            client_add() {
                ...
                if (!list)
                    return '';
                const client = list.remote_make({ '': $hyoo_crus_rank_read });
        ...
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm.prototype, "realm", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm.prototype, "profile", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm.prototype, "clients_all", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm.prototype, "search", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm.prototype, "status_filter", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm.prototype, "segment_filter", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm.prototype, "manager_filter", null);
        __decorate([
            $mol_action
        ], $bog_bhelper_app_crm.prototype, "filters_reset", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm.prototype, "status_options", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm.prototype, "segment_options", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm.prototype, "manager_options", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm.prototype, "clients_filtered", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm.prototype, "page", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm.prototype, "page_count", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm.prototype, "client_ids_page", null);
        __decorate([
            $mol_mem_key
        ], $bog_bhelper_app_crm.prototype, "client_row", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm.prototype, "client_rows", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm.prototype, "page_has_prev", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm.prototype, "page_has_next", null);
        __decorate([
            $mol_action
        ], $bog_bhelper_app_crm.prototype, "page_prev", null);
        __decorate([
            $mol_action
        ], $bog_bhelper_app_crm.prototype, "page_next", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm.prototype, "page_info_text", null);
        __decorate([
            $mol_mem_key
        ], $bog_bhelper_app_crm.prototype, "client", null);
        __decorate([
            $mol_action
        ], $bog_bhelper_app_crm.prototype, "client_add", null);
        $$.$bog_bhelper_app_crm = $bog_bhelper_app_crm;
        class $bog_bhelper_app_crm_client_row extends $.$bog_bhelper_app_crm_client_row {
            _client_id = '';
            client_id(next) {
                if (next !== undefined)
                    this._client_id = next;
        ...
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm_client_row.prototype, "client", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm_client_row.prototype, "Name", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm_client_row.prototype, "Company", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm_client_row.prototype, "Status", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm_client_row.prototype, "Segment", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm_client_row.prototype, "City", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm_client_row.prototype, "LastContact", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm_client_row.prototype, "NextAction", null);
        __decorate([
            $mol_mem
        ], $bog_bhelper_app_crm_client_row.prototype, "Manager", null);
        $$.$bog_bhelper_app_crm_client_row = $bog_bhelper_app_crm_client_row;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_bhelper_app_settings) = class $bog_bhelper_app_settings extends ($.$mol_page) {
		Language_select(){
		...
		Language_labeler(){
			...
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_bhelper_app_settings_Language_labeler_title")));
		...
		Install_button(){
			const obj = new this.$.$mol_button_major();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_bhelper_app_settings_Install_button_title")));
			(obj.click) = (next) => ((this.install(next)));
			return obj;
		}
		Install_labeler(){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_bhelper_app_settings_Install_labeler_title")));
			(obj.content) = () => ([(this.Install_button())]);
			return obj;
		}
		title(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_settings_title"));
		}
		body(){
			return [(this.Language_labeler()), (this.Install_labeler())];
		}
		install_ios_instruction(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_settings_install_ios_instruction"));
		}
		install_android_instruction(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_settings_install_android_instruction"));
		}
		install_desktop_instruction(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_settings_install_desktop_instruction"));
		}
		install_unsupported_browser(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_settings_install_unsupported_browser"));
		}
		install_already_installed(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_settings_install_already_installed"));
		}
	};
	($mol_mem(($.$bog_bhelper_app_settings.prototype), "Language_select"));
	($mol_mem(($.$bog_bhelper_app_settings.prototype), "Language_labeler"));
	($mol_mem(($.$bog_bhelper_app_settings.prototype), "install"));
	($mol_mem(($.$bog_bhelper_app_settings.prototype), "Install_button"));
	($mol_mem(($.$bog_bhelper_app_settings.prototype), "Install_labeler"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_bhelper_app_settings extends $.$bog_bhelper_app_settings {
            deferredPrompt = null;
            auto() {
                super.auto();
                if (typeof window === 'undefined')
        ...
        __decorate([
            $mol_action
        ], $bog_bhelper_app_settings.prototype, "install", null);
        $$.$bog_bhelper_app_settings = $bog_bhelper_app_settings;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
(function ($) {
    const { rem } = $mol_style_unit;
    $mol_style_define($bog_bhelper_app_settings, {
        width: rem(100),
    });
})($ || ($ = {}));
...
;
	($.$bog_bhelper_app) = class $bog_bhelper_app extends ($.$mol_book2_catalog) {
		Realm(){
		...
		Prof(){
			const obj = new this.$.$bog_bhelper_app_prof();
			return obj;
		}
		Crm(){
		...
		Menu_logo(){
			const obj = new this.$.$mol_image();
			(obj.uri) = () => ("bog/bhelper/assets/favicon_dark.ico");
			return obj;
		}
		menu_title(){
			return (this.$.$mol_locale.text("$bog_bhelper_app_menu_title"));
		}
		menu_tools(){
	...
	($mol_mem(($.$bog_bhelper_app.prototype), "Realm"));
	($mol_mem(($.$bog_bhelper_app.prototype), "Theme_toggle"));
	($mol_mem(($.$bog_bhelper_app.prototype), "Theme"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $bog_bhelper_app.prototype, "realm", null);
