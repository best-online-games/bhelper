...
declare namespace $.$$ {
    const $bog_bhelper_crm_profile_base: Omit<typeof $hyoo_crus_dict, "prototype"> & (new (...args: any[]) => $mol_type_override<$hyoo_crus_dict, {
        readonly Clients: (auto?: any) => {
            remote_list(next?: readonly $bog_bhelper_crm_client[] | undefined): readonly $bog_bhelper_crm_client[];
            remote_add(item: $bog_bhelper_crm_client): void;
            make(config: null | number | $hyoo_crus_rank_preset | $hyoo_crus_land): $bog_bhelper_crm_client;
            remote_make(config: $hyoo_crus_rank_preset): $bog_bhelper_crm_client;
            local_make(idea?: number): $bog_bhelper_crm_client;
            items(next?: readonly ((symbol & {
                $hyoo_crus_ref: symbol;
            }) | null)[] | undefined): readonly ((symbol & {
                $hyoo_crus_ref: symbol;
    ...
    export class $bog_bhelper_crm_profile extends $bog_bhelper_crm_profile_base {
    }
    const $bog_bhelper_crm_client_base: Omit<typeof $hyoo_crus_dict, "prototype"> & (new (...args: any[]) => $mol_type_override<$hyoo_crus_dict, {
        readonly Name: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly Company: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly Status: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly Segment: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly Source: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly Phone: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly Email: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly Telegram: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly WhatsApp: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly PreferredChannel: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly ManagerName: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly City: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly AverageCheck: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly LTV: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly VisitFrequency: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly PipelineStage: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly LastContactAt: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly NextActionAt: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly IsVIP: (auto?: any) => $hyoo_crus_atom_bool | null;
        readonly LastNote: (auto?: any) => $hyoo_crus_text | null;
        readonly AiSummary: (auto?: any) => $hyoo_crus_text | null;
        readonly AiNextStep: (auto?: any) => $hyoo_crus_text | null;
        readonly CreatedAt: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly UpdatedAt: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly TagsCsv: (auto?: any) => $hyoo_crus_text | null;
    }>) & {
        schema: {
            [x: string]: typeof $hyoo_crus_node;
        } & {
            readonly Name: typeof $hyoo_crus_atom_str;
            readonly Company: typeof $hyoo_crus_atom_str;
            readonly Status: typeof $hyoo_crus_atom_str;
            readonly Segment: typeof $hyoo_crus_atom_str;
            readonly Source: typeof $hyoo_crus_atom_str;
            readonly Phone: typeof $hyoo_crus_atom_str;
            readonly Email: typeof $hyoo_crus_atom_str;
            readonly Telegram: typeof $hyoo_crus_atom_str;
            readonly WhatsApp: typeof $hyoo_crus_atom_str;
            readonly PreferredChannel: typeof $hyoo_crus_atom_str;
            readonly ManagerName: typeof $hyoo_crus_atom_str;
            readonly City: typeof $hyoo_crus_atom_str;
            readonly AverageCheck: typeof $hyoo_crus_atom_str;
            readonly LTV: typeof $hyoo_crus_atom_str;
            readonly VisitFrequency: typeof $hyoo_crus_atom_str;
            readonly PipelineStage: typeof $hyoo_crus_atom_str;
            readonly LastContactAt: typeof $hyoo_crus_atom_str;
            readonly NextActionAt: typeof $hyoo_crus_atom_str;
            readonly IsVIP: typeof $hyoo_crus_atom_bool;
            readonly LastNote: typeof $hyoo_crus_text;
            readonly AiSummary: typeof $hyoo_crus_text;
            readonly AiNextStep: typeof $hyoo_crus_text;
            readonly CreatedAt: typeof $hyoo_crus_atom_str;
            readonly UpdatedAt: typeof $hyoo_crus_atom_str;
            readonly TagsCsv: typeof $hyoo_crus_text;
        };
    };
    export class $bog_bhelper_crm_client extends $bog_bhelper_crm_client_base {
    }
    export {};
}
...
declare namespace $.$$ {
    class $bog_bhelper_app_crm extends $.$bog_bhelper_app_crm {
        ...
        profile(): $bog_bhelper_crm_profile | null;
        clients_all(): readonly $bog_bhelper_crm_client[];
        search(next?: string): string;
        status_filter(next?: string): string;
        segment_filter(next?: string): string;
        manager_filter(next?: string): string;
        ...
        clients_filtered(): $bog_bhelper_crm_client[];
        page_size(): number;
        page(next?: number): number;
        page_count(): number;
        client_ids_page(): string[];
        client_row(id: string): $bog_bhelper_app_crm_client_row;
        client_rows(): $bog_bhelper_app_crm_client_row[];
        page_has_prev(): boolean;
        page_has_next(): boolean;
        page_prev(): string;
        page_next(): string;
        page_info_text(): string;
        client(id: string): $bog_bhelper_crm_client;
        client_add(): string;
    }
    class $bog_bhelper_app_crm_client_row extends $.$bog_bhelper_app_crm_client_row {
        private _client_id;
        client_id(next?: string): string;
        client(): $bog_bhelper_crm_client;
        Name(): string;
        Company(): string;
        Status(): string;
        Segment(): string;
...
declare namespace $ {
	...
	>
	type $gd_bot__Space_bog_bhelper_app_4 = $mol_type_enforce<
		any
		,
		ReturnType< $gd_bot['Space'] >
	>
	type $gd_bot__Sources_bog_bhelper_app_5 = $mol_type_enforce<
		any
		,
		ReturnType< $gd_bot['Sources'] >
	>
	type $gd_bot__Donate_bog_bhelper_app_6 = $mol_type_enforce<
		any
		,
		ReturnType< $gd_bot['Donate'] >
	>
	type $gd_bot__Support_bog_bhelper_app_7 = $mol_type_enforce<
		any
		,
		ReturnType< $gd_bot['Support'] >
	>
	type $gd_bot__Lights_bog_bhelper_app_8 = $mol_type_enforce<
		any
		,
